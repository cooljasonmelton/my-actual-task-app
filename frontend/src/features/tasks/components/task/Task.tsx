...
const noopSubtaskDragStart: NonNullable<TaskProps["onSubtaskDragStart"]> = () => {};
const noopSubtaskDragEnter: NonNullable<TaskProps["onSubtaskDragEnter"]> = () => {};
const noopSubtaskDragOver: NonNullable<TaskProps["onSubtaskDragOver"]> = () => {};
const noopSubtaskDragLeave: NonNullable<TaskProps["onSubtaskDragLeave"]> = () => {};
const noopSubtaskDrop: NonNullable<TaskProps["onSubtaskDrop"]> = () => {};
const noopSubtaskDragEnd: NonNullable<TaskProps["onSubtaskDragEnd"]> = () => {};
const noopSubtaskListDragOver: NonNullable<TaskProps["onSubtaskListDragOver"]> = () => {};
const noopSubtaskListDrop: NonNullable<TaskProps["onSubtaskListDrop"]> = () => {};
...
const Task = ({
  ...
  const safeDraggingSubtask = draggingSubtask ?? null;
  const safeDragOverSubtaskId = dragOverSubtaskId ?? null;
  const safeSubtaskDragStart = onSubtaskDragStart ?? noopSubtaskDragStart;
  const safeSubtaskDragEnter = onSubtaskDragEnter ?? noopSubtaskDragEnter;
  const safeSubtaskDragOver = onSubtaskDragOver ?? noopSubtaskDragOver;
  const safeSubtaskDragLeave = onSubtaskDragLeave ?? noopSubtaskDragLeave;
  const safeSubtaskDrop = onSubtaskDrop ?? noopSubtaskDrop;
  const safeSubtaskDragEnd = onSubtaskDragEnd ?? noopSubtaskDragEnd;
      ...
      >
        ...
        {isExpanded && (
          <TaskContent
            ...
            draggingSubtask={safeDraggingSubtask}
            dragOverSubtaskId={safeDragOverSubtaskId}
            onSubtaskDragStart={safeSubtaskDragStart}
            onSubtaskDragEnter={safeSubtaskDragEnter}
            onSubtaskDragOver={safeSubtaskDragOver}
            onSubtaskDragLeave={safeSubtaskDragLeave}
            onSubtaskDrop={safeSubtaskDrop}
            onSubtaskDragEnd={safeSubtaskDragEnd}
            onSubtaskListDragOver={safeSubtaskListDragOver}
            onSubtaskListDrop={safeSubtaskListDrop}
          />
        )}
      </div>
      <Modal
