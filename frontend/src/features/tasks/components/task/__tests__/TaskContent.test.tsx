...
const createProps = (
  ...
  onSubtaskDragStart: vi.fn(),
  onSubtaskDragEnter: vi.fn(),
  onSubtaskDragOver: vi.fn(),
  onSubtaskDragLeave: vi.fn(),
  onSubtaskDrop: vi.fn(),
  onSubtaskDragEnd: vi.fn(),
  onSubtaskListDragOver: vi.fn(),
  onSubtaskListDrop: vi.fn(),
  ...overrides,
});
